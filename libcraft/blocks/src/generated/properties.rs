...
impl BlockId {
    ...
    pub fn has_axis_xyz(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::Deepslate
            | BlockKind::InfestedDeepslate => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `berries` property."]
    pub fn has_berries(self) -> bool {
        match self.kind() {
            BlockKind::CaveVines | BlockKind::CaveVinesPlant => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `candles` property."]
    ...
    pub fn has_distance_1_7(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::FloweringAzaleaLeaves => true,
            _ => false,
        }
    }
    ...
    pub fn has_east_nlt(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::DeepslateBrickWall => true,
            _ => false,
        }
    }
    ...
    pub fn has_facing_cardinal(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::DeepslateBrickStairs => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `level_1_3` property."]
    pub fn has_level_1_3(self) -> bool {
        match self.kind() {
            BlockKind::WaterCauldron | BlockKind::PowderSnowCauldron => true,
            _ => false,
        }
    }
    ...
    pub fn has_lit(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::BlackCandleCake => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `sculk_sensor_phase` property."]
    pub fn has_sculk_sensor_phase(self) -> bool {
        match self.kind() {
            BlockKind::SculkSensor => true,
            _ => false,
        }
    ...
    pub fn has_slab_kind(self) -> bool {
        match self.kind() {
            ...
            | BlockKind::DeepslateBrickSlab => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `thickness` property."]
    ...
    #[doc = "Determines whether or not a block has the `tilt` property."]
    pub fn has_tilt(self) -> bool {
        match self.kind() {
            BlockKind::BigDripleaf => true,
            _ => false,
        }
    }
    ...
    #[doc = "Determines whether or not a block has the `vertical_direction` property."]
    pub fn has_vertical_direction(self) -> bool {
        match self.kind() {
            BlockKind::PointedDripstone => true,
            _ => false,
        }
    ...
    pub fn has_water_level(self) -> bool {
        match self.kind() {
            BlockKind::Water | BlockKind::Lava | BlockKind::Light => true,
            _ => false,
        }
    }
