...
pub struct BlockTable {
    ...
    sculk_sensor_phase: Vec<(u16, u16)>,
    short: Vec<(u16, u16)>,
    ...
    thickness: Vec<(u16, u16)>,
    tilt: Vec<(u16, u16)>,
    triggered: Vec<(u16, u16)>,
    unstable: Vec<(u16, u16)>,
    up: Vec<(u16, u16)>,
    vertical_direction: Vec<(u16, u16)>,
...
impl BlockTable {
    ...
    #[doc = "Retrieves the `berries` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn berries(&self, kind: BlockKind, state: u16) -> Option<bool> {
        let (offset_coefficient, stride) = self.berries[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
    ...
    #[doc = "Updates the state value for the given block kind such that its `berries` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_berries(&self, kind: BlockKind, state: u16, value: bool) -> Option<u16> {
        let (offset_coefficient, stride) = self.berries[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
    ...
    #[doc = "Retrieves the `candles` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn candles(&self, kind: BlockKind, state: u16) -> Option<i32> {
        let (offset_coefficient, stride) = self.candles[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
    ...
    #[doc = "Updates the state value for the given block kind such that its `candles` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_candles(&self, kind: BlockKind, state: u16, value: i32) -> Option<u16> {
        let (offset_coefficient, stride) = self.candles[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
    ...
    #[doc = "Retrieves the `level_1_3` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn level_1_3(&self, kind: BlockKind, state: u16) -> Option<i32> {
        let (offset_coefficient, stride) = self.level_1_3[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
    ...
    #[doc = "Updates the state value for the given block kind such that its `level_1_3` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_level_1_3(&self, kind: BlockKind, state: u16, value: i32) -> Option<u16> {
        let (offset_coefficient, stride) = self.level_1_3[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
    ...
    #[doc = "Retrieves the `sculk_sensor_phase` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn sculk_sensor_phase(&self, kind: BlockKind, state: u16) -> Option<SculkSensorPhase> {
        let (offset_coefficient, stride) = self.sculk_sensor_phase[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
        Some(SculkSensorPhase::try_from(x).expect("invalid block state"))
    }
    #[doc = "Updates the state value for the given block kind such that its `sculk_sensor_phase` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_sculk_sensor_phase(
        &self,
        kind: BlockKind,
        state: u16,
        value: SculkSensorPhase,
    ) -> Option<u16> {
        let (offset_coefficient, stride) = self.sculk_sensor_phase[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
    ...
    #[doc = "Retrieves the `thickness` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn thickness(&self, kind: BlockKind, state: u16) -> Option<Thickness> {
        let (offset_coefficient, stride) = self.thickness[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
        Some(Thickness::try_from(x).expect("invalid block state"))
    }
    #[doc = "Updates the state value for the given block kind such that its `thickness` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_thickness(&self, kind: BlockKind, state: u16, value: Thickness) -> Option<u16> {
        let (offset_coefficient, stride) = self.thickness[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
    ...
    #[doc = "Retrieves the `tilt` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn tilt(&self, kind: BlockKind, state: u16) -> Option<Tilt> {
        let (offset_coefficient, stride) = self.tilt[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
        Some(Tilt::try_from(x).expect("invalid block state"))
    }
    #[doc = "Updates the state value for the given block kind such that its `tilt` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
    pub fn set_tilt(&self, kind: BlockKind, state: u16, value: Tilt) -> Option<u16> {
        let (offset_coefficient, stride) = self.tilt[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
    ...
    #[doc = "Retrieves the `vertical_direction` value for the given block kind with the given state value.\n        Returns the value of the property, or `None` if it does not exist."]
    pub fn vertical_direction(&self, kind: BlockKind, state: u16) -> Option<VerticalDirection> {
        let (offset_coefficient, stride) = self.vertical_direction[kind as u16 as usize];
        if offset_coefficient == 0 {
            return None;
        }
        let x = n_dimensional_index(state, offset_coefficient, stride);
        Some(VerticalDirection::try_from(x).expect("invalid block state"))
    }
    #[doc = "Updates the state value for the given block kind such that its `vertical_direction` value is updated. Returns the new state,\n        or `None` if the block does not have this property."]
...
impl TryFrom<u16> for SculkSensorPhase {
    type Error = anyhow::Error;
    fn try_from(value: u16) -> anyhow::Result<Self> {
        match value {
            0u16 => Ok(SculkSensorPhase::Inactive),
            1u16 => Ok(SculkSensorPhase::Active),
            2u16 => Ok(SculkSensorPhase::Cooldown),
            x => Err(anyhow::anyhow!("invalid value {} for SculkSensorPhase", x)),
        }
    }
}
...
impl TryFrom<u16> for Thickness {
    ...
    fn try_from(value: u16) -> anyhow::Result<Self> {
        match value {
            0u16 => Ok(Thickness::TipMerge),
            1u16 => Ok(Thickness::Tip),
            2u16 => Ok(Thickness::Frustum),
            3u16 => Ok(Thickness::Middle),
            4u16 => Ok(Thickness::Base),
            x => Err(anyhow::anyhow!("invalid value {} for Thickness", x)),
        }
    }
}
...
impl TryFrom<u16> for Tilt {
    type Error = anyhow::Error;
    fn try_from(value: u16) -> anyhow::Result<Self> {
        match value {
            0u16 => Ok(Tilt::None),
            1u16 => Ok(Tilt::Unstable),
            2u16 => Ok(Tilt::Partial),
            3u16 => Ok(Tilt::Full),
            x => Err(anyhow::anyhow!("invalid value {} for Tilt", x)),
        }
    }
}
impl FromStr for Tilt {
    ...
    fn from_str(s: &str) -> anyhow::Result<Self> {
        match s {
            ...
            "full" => Ok(Tilt::Full),
            _ => Err(anyhow::anyhow!("invalid value for {}", stringify!(Tilt))),
        }
    }
}
impl Tilt {
...
impl TryFrom<u16> for VerticalDirection {
    type Error = anyhow::Error;
    fn try_from(value: u16) -> anyhow::Result<Self> {
        match value {
            0u16 => Ok(VerticalDirection::Up),
            1u16 => Ok(VerticalDirection::Down),
            x => Err(anyhow::anyhow!("invalid value {} for VerticalDirection", x)),
        }
    }
}
