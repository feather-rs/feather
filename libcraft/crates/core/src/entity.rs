...
impl EntityKind {
    ...
    pub fn id(&self) -> u32 {
        match self {
            ...
            EntityKind::Pillager => 61,
            EntityKind::PolarBear => 62,
            EntityKind::Tnt => 63,
            EntityKind::Pufferfish => 64,
            EntityKind::Rabbit => 65,
            EntityKind::Ravager => 66,
            EntityKind::Salmon => 67,
            EntityKind::Sheep => 68,
            EntityKind::Shulker => 69,
            EntityKind::ShulkerBullet => 70,
            EntityKind::Silverfish => 71,
            EntityKind::Skeleton => 72,
            EntityKind::SkeletonHorse => 73,
            EntityKind::Slime => 74,
            EntityKind::SmallFireball => 75,
            EntityKind::SnowGolem => 76,
            EntityKind::Snowball => 77,
            EntityKind::SpectralArrow => 78,
            EntityKind::Spider => 79,
            EntityKind::Squid => 80,
            EntityKind::Stray => 81,
            EntityKind::Strider => 82,
            EntityKind::Egg => 83,
            EntityKind::EnderPearl => 84,
            EntityKind::ExperienceBottle => 85,
            EntityKind::Potion => 86,
            EntityKind::Trident => 87,
            EntityKind::TraderLlama => 88,
            EntityKind::TropicalFish => 89,
            EntityKind::Turtle => 90,
            EntityKind::Vex => 91,
            EntityKind::Villager => 92,
            EntityKind::Vindicator => 93,
            EntityKind::WanderingTrader => 94,
            EntityKind::Witch => 95,
            EntityKind::Wither => 96,
            EntityKind::WitherSkeleton => 97,
            EntityKind::WitherSkull => 98,
            EntityKind::Wolf => 99,
            EntityKind::Zoglin => 100,
            EntityKind::Zombie => 101,
            EntityKind::ZombieHorse => 102,
            EntityKind::ZombieVillager => 103,
            EntityKind::ZombifiedPiglin => 104,
            EntityKind::Player => 105,
            EntityKind::FishingBobber => 106,
        }
    }
    ...
    pub fn from_id(id: u32) -> Option<Self> {
        match id {
            ...
            61 => Some(EntityKind::Pillager),
            62 => Some(EntityKind::PolarBear),
            63 => Some(EntityKind::Tnt),
            64 => Some(EntityKind::Pufferfish),
            65 => Some(EntityKind::Rabbit),
            66 => Some(EntityKind::Ravager),
            67 => Some(EntityKind::Salmon),
            68 => Some(EntityKind::Sheep),
            69 => Some(EntityKind::Shulker),
            70 => Some(EntityKind::ShulkerBullet),
            71 => Some(EntityKind::Silverfish),
            72 => Some(EntityKind::Skeleton),
            73 => Some(EntityKind::SkeletonHorse),
            74 => Some(EntityKind::Slime),
            75 => Some(EntityKind::SmallFireball),
            76 => Some(EntityKind::SnowGolem),
            77 => Some(EntityKind::Snowball),
            78 => Some(EntityKind::SpectralArrow),
            79 => Some(EntityKind::Spider),
            80 => Some(EntityKind::Squid),
            81 => Some(EntityKind::Stray),
            82 => Some(EntityKind::Strider),
            83 => Some(EntityKind::Egg),
            84 => Some(EntityKind::EnderPearl),
            85 => Some(EntityKind::ExperienceBottle),
            86 => Some(EntityKind::Potion),
            87 => Some(EntityKind::Trident),
            88 => Some(EntityKind::TraderLlama),
            89 => Some(EntityKind::TropicalFish),
            90 => Some(EntityKind::Turtle),
            91 => Some(EntityKind::Vex),
            92 => Some(EntityKind::Villager),
            93 => Some(EntityKind::Vindicator),
            94 => Some(EntityKind::WanderingTrader),
            95 => Some(EntityKind::Witch),
            96 => Some(EntityKind::Wither),
            97 => Some(EntityKind::WitherSkeleton),
            98 => Some(EntityKind::WitherSkull),
            99 => Some(EntityKind::Wolf),
            100 => Some(EntityKind::Zoglin),
            101 => Some(EntityKind::Zombie),
            102 => Some(EntityKind::ZombieHorse),
            103 => Some(EntityKind::ZombieVillager),
            104 => Some(EntityKind::ZombifiedPiglin),
            105 => Some(EntityKind::Player),
            106 => Some(EntityKind::FishingBobber),
            _ => None,
        }
    }
}
